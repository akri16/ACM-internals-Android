...
public class RequestsRvAdapter
  extends RecyclerView.Adapter<RequestsRvAdapter.RequestRvVH> {
  ...
  @NonNull
  @Override
  public RequestRvVH onCreateViewHolder(
    @NonNull ViewGroup parent,
    int viewType
  ) {
    LayoutInflater inflater = LayoutInflater.from(parent.getContext());
    ItemRequestsBinding binding = ItemRequestsBinding.inflate(
      inflater,
      parent,
      false
    );
